...
df_train = df_train.query("5<=area<=150")  # 线下 lgb_0.8830538988139025 线上0.867
...
df_train = df_train.sort_values(by=['communityName', 'houseFloor', 'tradeTime'], ascending=(True, True, True))
df_test = df_test.sort_values(by=['communityName', 'houseFloor', 'tradeTime'], ascending=(True, True, True))
